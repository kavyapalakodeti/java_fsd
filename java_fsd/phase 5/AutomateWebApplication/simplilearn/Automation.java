...
public class Automation {
	...
	public void register() {
			...
			driver.findElement(By.name("customerName")).sendKeys("kavya");	
			driver.findElement(By.name("email")).sendKeys("kavya2323@gmail.com");
			driver.findElement(By.name("password")).sendKeys("kavya@123");
			driver.findElement(By.name("passwordCheck")).sendKeys("kavya@123");
